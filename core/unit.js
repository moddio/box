...
export class Unit extends Entity {
  ...
  spawnBox() {
    ...
    console.log(projectile.mesh);
    projectile.mesh.physicsImpostor = new BABYLON.PhysicsImpostor(
      mesh,
  ...
  spawnPlane() {
    ...
    scene.enablePhysics(undefined, new BABYLON.AmmoJSPlugin());
    new BABYLON.PhysicsImpostor(mesh, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0.5, restitution: 0.7 }, scene);
    /**
